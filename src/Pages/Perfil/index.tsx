...
const restaurant: Dishes[] = [
  ...
  },
  {
    ...
    description:
      'O risoto (arrozinho, traduzindo do Italiano) é uma importante refeição que compõem os pratos típicos da Itália. Surgiu no norte da Itália, mais especificamente na Lombardia. É composto primordialmente por arroz, fritado levemente com cebolas (e outros legumes) na manteiga.',
    description2:
  ...
  },
  {
    ...
    description:
      'Não poderíamos falar de pratos típicos italianos em 7 delícias e deixar de lado a Lasanha. O prato é uma massa em folhas venerada nos quatro cantos do mundo. Preparado no forno, a receita original leva camadas alternadas de massa, queijo, molho de carne. A palavra lasanha vem de “lasanon” (grego), que significa pote de cozinhas. Eles usavam a palavra para definir o prato onde se preparava a Lasanha.',
    description2:
  ...
  },
  {
    ...
    description:
      'Essa comida típica da Itália, diferente das citadas, é menos conhecida pelos brasileiros, no entanto, saboreada em toda a Itália. A bruschetta hoje é servida como antepasto, ela surgiu na região do Lázio. Entre trabalhadores rurais há muitos séculos, como uma inteligente forma de reaproveitar pão velho.',
    description2:
